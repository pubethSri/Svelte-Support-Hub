...
<nav
  class="bg-white dark:bg-gray-900 shadow-md sticky top-0 left-0 w-full z-50"
>
    ...
    <div class="h-full flex justify-between items-center py-4">
      ...
      <div class="flex items-center gap-4">
        <Button
          ...
          variant="outline"
          size="icon"
          class="cursor-pointer dark:bg-gray-800 dark:text-gray-300"
        >
          <SunIcon
        ...
        {#if currentUser}
          <DropdownMenu.Root>
            ...
            <DropdownMenu.Content align="end">
              <DropdownMenu.Label
                >{currentUser.role.toUpperCase()}</DropdownMenu.Label
              >
